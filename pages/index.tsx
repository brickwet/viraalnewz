    ...
    <div className={styles.container}>
      ...
      <main className={styles.main}>
        <h1 className={styles.title}>
          Welcome to Vercel Trick By <a href="http://viraalnewz.great-site.net">Alcash Zone</a>
        </h1>
        ...
        <div className={styles.grid}>
          <a href="https://http://viraalnewz.great-site.net/category/adsterra-earning/" className={styles.card}>
            <h2>Documentation &rarr;</h2>
            <p>Here you can find how to earn money from Adsterra .</p>
          </a>

          <a href="https://viraalnewz.great-site.net/category/adsense-approval/" className={styles.card}>
            <h2>Master In AdSense Approval &rarr;</h2>
            <p>Here you can find the of how you become master in AdSense approval!</p>
          </a>

          <a
            href="https://viraalnewz.great-site.net/category/blogging/"
